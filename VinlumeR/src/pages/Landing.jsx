...
export default function Landing() {
  ...
  // Lógica para el botón de favoritos (reemplaza el script de Vanilla JS)
            ...
            <div className="grid" role="list">
              ...
              <article className="card holo-card" role="listitem">
                ...
                <div className="card-body">
                  ...
                  <div className="tags"><span className="tag">Rap Metal</span><span className="tag">Rock</span></div>
              ...
              <article className="card holo-card" role="listitem">
                ...
                <div className="card-body">
                  ...
                  <div className="tags"><span className="tag">Alternative</span><span className="tag">Indie Pop</span></div>
                  <div className="card-footer">
                    <p className="precio">CLP 4.990</p>
                    <button className="btn buy-btn">Comprar</button>
                  </div>
              ...
              <article className="card holo-card" role="listitem">
                ...
                <div className="card-body">
                  ...
                  <div className="tags"><span className="tag">Rock Chileno</span><span className="tag">Indie</span></div>
                  <div className="card-footer">
                    <p className="precio">CLP 4.990</p>
                    <button className="btn buy-btn">Comprar</button>
                  </div>
              ...
              <article className="card holo-card" role="listitem">
                ...
                <div className="card-body">
                  ...
                  <div className="tags"><span className="tag">J-Pop</span><span className="tag">Vocaloid</span></div>
                  <div className="card-footer">
                    <p className="precio">CLP 4.990</p>
                    <button className="btn buy-btn">Comprar</button>
                  </div>
              ...
              <article className="card holo-card" role="listitem">
                <div className="card-image">
                  <img src="/images/bikini kill/The First two records/The First1.webp" alt="Bikini Kill" />
                  <button className="fav-btn" aria-label="Añadir a favoritos" onClick={toggleFavorito}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                  </button>
                </div>
                <div className="card-body">
                  <h2>The First Two Records</h2>
                  <p className="artista">Bikini Kill</p>
                  <div className="tags"><span className="tag">Punk</span><span className="tag">Riot Grrrl</span></div>
                  <div className="card-footer">
                    <p className="precio">CLP 4.990</p>
                    <button className="btn buy-btn">Comprar</button>
                  </div>
              ...
              <article className="card holo-card" role="listitem">
                <div className="card-image">
                  <img src="/images/cuarteto de nos/habla tu espejo/1.jpg" alt="Cuarteto de Nos" />
                  <button className="fav-btn" aria-label="Añadir a favoritos" onClick={toggleFavorito}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                  </button>
                </div>
                <div className="card-body">
                  <h2>Habla Tu Espejo</h2>
                  <p className="artista">Cuarteto de Nos</p>
                  <div className="tags"><span className="tag">Art Rock</span><span className="tag">Post-Punk</span></div>
                  <div className="card-footer">
                    <p className="precio">CLP 4.990</p>
                    <button className="btn buy-btn">Comprar</button>
                  </div>
              ...
              <article className="card holo-card" role="listitem">
                <div className="card-image">
                  <img src="/images/top/blurryface/blurry1.jpg" alt="Twenty One Pilots - Blurryface" />
                  <button className="fav-btn" aria-label="Añadir a favoritos" onClick={toggleFavorito}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                  </button>
                </div>
                <div className="card-body">
                  <h2>Blurryface</h2>
                  <p className="artista">Twenty One Pilots</p>
                  <div className="tags"><span className="tag">Alternative</span><span className="tag">Hip Hop</span></div>
                  <div className="card-footer">
                    <p className="precio">CLP 4.990</p>
                    <button className="btn buy-btn">Comprar</button>
                  </div>
              ...
              <article className="card holo-card" role="listitem">
                <div className="card-image">
                  <img src="/images/top/breach/breach1.jpg" alt="Twenty One Pilots - Breach" />
                  <button className="fav-btn" aria-label="Añadir a favoritos" onClick={toggleFavorito}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                  </button>
                </div>
                <div className="card-body">
                  <h2>Breach</h2>
                  <p className="artista">Twenty One Pilots</p>
                  <div className="tags"><span className="tag">Rock Alternativo</span><span className="tag">Concept</span></div>
                  <div className="card-footer">
                    <p className="precio">CLP 4.990</p>
                    <button className="btn buy-btn">Comprar</button>
                  </div>
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              <a href="https://www.instagram.com/vinlume_disk/" target="_blank" rel="noreferrer" className="social-link">Instagram</a>
            </div>
          </div>
        </div>
